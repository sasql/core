...
export const patterns = [
    ...
    ...getSasqlSyntax(),
    {
        captures: {
            1: {
                name: 'keyword.other.create.sasql'
            },
            2: {
                name: 'keyword.other.sasql'
            }
        },
    ...
    },
    {
        captures: {
            ...
            2: {
                name: 'keyword.other.table.sasql'
            },
            3: {
                name: 'entity.name.function.sasql'
            },
            4: {
                name: 'keyword.other.cascade.sasql'
            }
        },
    ...
    },
    {
        ...
        name: 'meta.alter.sasql'
    },
    {
        captures: {
            1: {
                name: 'storage.type.sasql'
            },
            2: {
                name: 'storage.type.sasql'
            },
            3: {
                name: 'constant.numeric.sasql'
            },
            4: {
                name: 'storage.type.sasql'
            },
    ...
    },
    {
        ...
        name: 'keyword.other.DML.sasql'
    },
    {
        match: '(?i:\\b(on|off|((is\\s+)?not\\s+)?null)\\b)',
        name: 'keyword.other.DDL.create.II.sasql'
    },
    {
        match: '(?i:\\bvalues\\b)',
        name: 'keyword.other.DML.II.sasql'
    },
    {
        match: '(?i:\\b(begin(\\s+work)?|start\\s+transaction|commit(\\s+work)?|rollback(\\s+work)?)\\b)',
        name: 'keyword.other.LUW.sasql'
    },
    {
        match: '(?i:\\b(grant(\\swith\\sgrant\\soption)?|revoke)\\b)',
        name: 'keyword.other.authorization.sasql'
    },
    {
        match: '(?i:\\bin\\b)',
        name: 'keyword.other.data-integrity.sasql'
    },
    {
        match: '(?i:^\\s*(comment\\s+on\\s+(table|column|aggregate|constraint|database|domain|function|index|operator|rule|schema|sequence|trigger|type|view))\\s+.*?\\s+(is)\\s+)',
        name: 'keyword.other.object-comments.sasql'
    },
    {
        match: '(?i)\\bAS\\b',
        name: 'keyword.other.alias.sasql'
    },
    {
        match: '(?i)\\b(DESC|ASC)\\b',
        name: 'keyword.other.order.sasql'
    },
    {
        match: '\\*',
        name: 'keyword.operator.star.sasql'
    },
    {
        match: '[!<>]?=|<>|<|>',
        name: 'keyword.operator.comparison.sasql'
    },
    {
        match: '-|\\+|/',
        name: 'keyword.operator.math.sasql'
    },
    {
        match: '\\|\\|',
        name: 'keyword.operator.concatenator.sasql'
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.aggregate.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.analytic.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.bitmanipulation.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.conversion.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.collation.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.cryptographic.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.cursor.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.datetime.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.datatype.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.expression.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.globalvar.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.json.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.logical.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.mathematical.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.metadata.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.ranking.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.rowset.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.security.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.string.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.system.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.textimage.sasql'
            }
        }
    },
    {
        ...
        captures: {
            1: {
                name: 'support.function.vector.sasql'
            }
        }
    },
    {
        captures: {
            1: {
                name: 'constant.other.database-name.sasql'
            },
            2: {
                name: 'constant.other.table-name.sasql'
            }
        },
        match: '(\\w+?)\\.(\\w+)'
    },
    ...
    },
    {
        captures: {
            1: {
                name: 'punctuation.section.scope.begin.sasql'
            },
            2: {
                name: 'punctuation.section.scope.end.sasql'
            }
        },
        comment: 'Allow for special ↩ behavior',
        match: '(\\()(\\))',
        name: 'meta.block.sasql'
    }
];
